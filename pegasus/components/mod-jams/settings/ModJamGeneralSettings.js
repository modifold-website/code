...
export default function ModJamGeneralSettings({ authToken, jam }) {
	...
	const [avatarPreview, setAvatarPreview] = useState(jam.avatar_url || "/images/no-project-icon.svg");
	const [coverPreview, setCoverPreview] = useState(jam.cover_url || "");
	const [savedAvatarPreview, setSavedAvatarPreview] = useState(jam.avatar_url || "/images/no-project-icon.svg");
