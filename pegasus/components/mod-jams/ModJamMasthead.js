			...
			<section className="mod-jam-sidebar-card">
				...
				<div className="mod-jam-sidebar-card-body">
					<div className="mod-jam-sidebar-card-header">
						<img className="mod-jam-sidebar-card-icon" src={jam.avatar_url || "/images/no-project-icon.svg"} alt="" />
					...
					{permissions.can_edit && (
						<Link prefetch={false} className="button button--size-m button--with-icon button--active-transform button--type-minimal" href={`/jams/${jam.slug}/settings`}>
