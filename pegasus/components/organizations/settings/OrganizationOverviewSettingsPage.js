...
export default function OrganizationOverviewSettingsPage({ authToken, organization, my_permissions }) {
    ...
    const [iconUrl, setIconUrl] = useState(organization?.icon_url || "/images/no-project-icon.svg");
    const [savedIconUrl, setSavedIconUrl] = useState(organization?.icon_url || "/images/no-project-icon.svg");
    const [iconFile, setIconFile] = useState(null);
    const [previewIcon, setPreviewIcon] = useState(organization?.icon_url || "/images/no-project-icon.svg");
    ...
    const currentOrganization = { ...organization, slug: savedSlug || organization?.slug, name, icon_url: iconUrl || "/images/no-project-icon.svg" };
                ...
                {canEditDetails && (
                    <UnsavedChangesBar
                        ...
                        onReset={() => {
                            ...
                            setIconFile(null);
                            setPreviewIcon(savedIconUrl || iconUrl || "/images/no-project-icon.svg");
                            if(iconInputRef.current) {
                                iconInputRef.current.value = "";
                            }
                        }}
