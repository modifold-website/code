    ...
    return (
        <div className="sidebar">
            <div className="sidebar__main">
                <Link prefetch={false} href={`/organization/${organization.slug}`} className="sidebar-item" data-ripple>
                    <img src={organization.icon_url || "/images/no-project-icon.svg"} alt={t("settings.iconAlt", { name: organization.name })} className="icon" width="28" height="28" style={{ borderRadius: "8px" }} />
                ...
                <Link prefetch={false} href={basePath} className={`sidebar-item ${isActive(basePath) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link prefetch={false} href={`${basePath}/members`} className={`sidebar-item ${isActive(`${basePath}/members`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link prefetch={false} href={`${basePath}/links`} className={`sidebar-item ${isActive(`${basePath}/links`) ? "sidebar-item--active" : ""}`} data-ripple>
                ...
                <Link prefetch={false} href={`${basePath}/projects`} className={`sidebar-item ${isActive(`${basePath}/projects`) ? "sidebar-item--active" : ""}`} data-ripple>
