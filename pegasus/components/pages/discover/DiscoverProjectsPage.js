...
export default function DiscoverProjectsPage({ data }) {
	...
	return (
		<div className="discover-page">
			...
			)} projects={weeklyPopular} t={t} tCategoryLabels={tCategoryLabels} />
			...
			)} projects={weeklyNewPopular} t={t} tCategoryLabels={tCategoryLabels} />
			...
			<section className="discover-more">
				...
				<Link prefetch={false} href="/jams" className="button button--size-m button--type-primary button--active-transform button--with-icon">
