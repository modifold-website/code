...
export default function PopularCategories({ categories, tCategoryLabels, t, browseHref }) {
		...
		<section className="discover-section">
			...
			<div className="discover-category-grid">
				{categories.map((category) => (
					<Link key={category.name} href={`${browseHref}?c=${encodeURIComponent(category.name)}`} className="discover-category-pill">
