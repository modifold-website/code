                    ...
                    <main className="profile-page__main">
                        <section className="profile-hero">
                            <div className="profile-hero__cover-wrap">
                                ...
                                {isOwnProfile && !authorCover && (
                                    <button className="button button--size-m button--type-minimal button--with-icon subsite-cover-editor__centered" type="button" onClick={() => coverInputRef.current?.click()}>
