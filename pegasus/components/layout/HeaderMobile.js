            ...
            <div className="header-mobile">
                <div className="bar bar--bottom">
                    <div className={`tabbar ${animatingItem ? "tabbar--animating" : ""}`}>
						...
						<Link href="/discover" className={`tabbar__item ${isItemActive("discover", "/discover") ? "tabbar__item--active" : ""} ${animatingItem === "discover" ? "tabbar__item--animating" : ""}`} onPointerDown={() => activateTab("discover")} aria-label={t("browse")} data-ripple="center">
