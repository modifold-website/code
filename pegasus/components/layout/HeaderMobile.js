...
export default function HeaderMobile({ authToken }) {
    ...
    useEffect(() => {
		...
		if(pathname === "/discover" && pendingActiveItem === "discover") {
			setPendingActiveItem(null);
		}
            ...
            <div className="header-mobile">
                <div className="bar bar--bottom">
                    <div className={`tabbar ${animatingItem ? "tabbar--animating" : ""}`}>
                        <Link prefetch={false} href="/" className={`tabbar__item ${isItemActive("home", "/") ? "tabbar__item--active" : ""} ${animatingItem === "home" ? "tabbar__item--animating" : ""}`} onPointerDown={() => activateTab("home")} aria-label={t("home")} data-ripple="center">
						...
						<Link prefetch={false} href="/discover" className={`tabbar__item ${isItemActive("discover", "/discover") ? "tabbar__item--active" : ""} ${animatingItem === "discover" ? "tabbar__item--animating" : ""}`} onPointerDown={() => activateTab("discover")} aria-label={t("browse")} data-ripple="center">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="tabbar__icon" onAnimationEnd={() => handleTabAnimationEnd("discover")}>
                        ...
                        {isLoggedIn && (
                            <Link prefetch={false} href="/notifications" className={`tabbar__item ${isItemActive("notifications", "/notifications") ? "tabbar__item--active" : ""} ${animatingItem === "notifications" ? "tabbar__item--animating" : ""}`} onPointerDown={() => activateTab("notifications")} aria-label={t("notifications")} data-ripple="center">
                                {unreadCount > 0 && (
