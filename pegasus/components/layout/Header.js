            ...
            <div className="header">
                <div className="header__layout">
                    <div className="header__left">
                        <Link prefetch={false} href="/" className="sidebarOpacity" aria-label={t("home")}>
                            {isStaging ? (                          
							...
							<div className="account-menu">
								<nav className="account-menu__section" aria-label={t("browse")}>
									<div className="account-action">
										<Link prefetch={false} href="/discover" onClick={closeBrowseMenu} className={`account-action__wrapper browse-menu__link button--active-transform ${isDiscoverActive ? "browse-menu__link--active" : ""}`} aria-current={isDiscoverActive ? "page" : undefined}>
									...
									<div className="account-action">
										<Link prefetch={false} href="/mods" onClick={closeBrowseMenu} className={`account-action__wrapper browse-menu__link button--active-transform ${isModsActive ? "browse-menu__link--active" : ""}`} aria-current={isModsActive ? "page" : undefined}>
											<svg className="icon account-action__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
									...
									<div className="account-action">
										<Link prefetch={false} href="/prefabs" onClick={closeBrowseMenu} className={`account-action__wrapper browse-menu__link button--active-transform ${isPrefabsActive ? "browse-menu__link--active" : ""}`} aria-current={isPrefabsActive ? "page" : undefined}>
									...
									<div className="account-action">
										<Link prefetch={false} href="/worlds" onClick={closeBrowseMenu} className={`account-action__wrapper browse-menu__link button--active-transform ${isWorldsActive ? "browse-menu__link--active" : ""}`} aria-current={isWorldsActive ? "page" : undefined}>
											<svg className="icon account-action__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    ...
                    <div className="header__right">
                        {isLoggedIn ? (
                                ...
                                <div className="account-button" ref={buttonRef}>
                                    ...
                                    <div className={`bubble account-menu-root user-menu ${isMenuOpen ? "open" : ""}`} ref={menuRef}>
                                        <div className="account-menu">
                                            ...
                                            <Link prefetch={false} href={`/user/${user?.slug}`} className="account-menu__user-card button--active-transform" onClick={closeAccountMenu}>
                                            ...
                                            <div className="account-menu__section">
                                                {(user?.isRole === "admin" || user?.isRole === "moderator") && (
                                                    <div className="account-action">
                                                        <Link prefetch={false} href="/moderation" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                ...
                                                <div className="account-action">
                                                    <Link prefetch={false} href="/dashboard" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                ...
                                                <div className="account-action">
                                                    <Link prefetch={false} href="/dashboard/organizations" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                ...
                                                <div className="account-action">
                                                    <Link prefetch={false} href="/dashboard/likes" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                ...
                                                <div className="account-action">
                                                    <Link prefetch={false} href="/notifications" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                ...
                                                <div className="account-action">
                                                    <Link prefetch={false} href="/settings" className="account-action__wrapper button--active-transform" onClick={closeAccountMenu}>
                                                        <svg className="icon icon--settings account-action__icon" height="24" width="24" viewBox="0 0 24 24">
                            ...
                            <>
                                ...
                                <Link prefetch={false} href="/settings/appearance" className="button button--size-l button--type-secondary button--rounded button--icon-only button--active-transform" aria-label={t("settings")} style={{ width: "42px" }}>
